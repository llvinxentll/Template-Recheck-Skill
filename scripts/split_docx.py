...
def main():
    ...
    def hdr(title, what):
        return (f"# {title} — {base}\n"
                ...
                f"# ⚠️ เลขแผ่นในป้ายเป็น **ค่าประมาณ** ใช้จัดลำดับแถวเท่านั้น\n"
                f"#   ห้ามเขียนลงในช่อง issue และ **ห้ามใช้สรุปว่าอะไรข้ามหน้า/เกินหน้า**\n"
                f"#   (เกิน 1 หน้า · องค์ประกอบปกไม่อยู่หน้าเดียวกัน · บทไม่ขึ้นหน้าใหม่)\n"
                f"#   ข้อสรุปแบบนั้นต้องมี pagemap.json จาก page_truth.py เท่านั้น\n"
